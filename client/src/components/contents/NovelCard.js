...
// 				style={{
// 					backgroundImage: `url(${process.env.REACT_APP_COVER_IMAGE_DIRECTORY}/${props.cover_image})`,
...
// 									pickNovel={pickNovel}	// 하트 아이콘 눌렀을 때 실행될 기능
// 								/>
// 							) : (
// 								<Icons
...
const NovelCard = (props) => {
  ...
  console.log(props.cover_image, 999)
