...
const EditProfile = (props) => {
  ...
  console.log(props)
	...
	const { closeModal, id, idRegMsg, idValidate, profile, pw, pwRegMsg, pwValidate, setId, setIdRegMsg, setProfile, setPw, setPwRegMsg  } = props;
...
const confirmNewPassword = (e) => {
  ...
  if(e.target.value !== newPw) {
    ...
    // }
        ...
        const newData = JSON.stringify({...profile, user_nickname: res.data})
        setProfile(newData);
