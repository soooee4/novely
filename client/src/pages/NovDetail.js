...
//   const [selectedTab, setSelectedTab] = useState("latest");    // 서브 소설 정렬 선택된 버튼
...
//                 setSelectedTab={() => setSelectedTab("latest")}
//                 fontWeight={selectedTab === "latest" && "bolder"}
// 							/>
//               |
// 							<Buttons
// 								type={CODE.BUTTON.BASIC}
...
//                 setSelectedTab={() => setSelectedTab("popular")}
//                 fontWeight={selectedTab === "popular" && "bolder"}
